		...
		if(!$co){
			...
			if(!$db){
				echo"<script>alert('Sorry, Database Not Found.');</script>";
					...
					$query="insert into  userRegistration(`regNo`,`firstName`,`middleName`,`lastName`,`gender`,`contactNo`,`email`,`password`,`imageName`,`imagePath`)
							values('$regno','$fname','$mname','$lname','$gender','$contactno','$emailid','$password','".basename( $_FILES["fileToUpload"]["name"])."','uploads/".basename( $_FILES["fileToUpload"]["name"])."')";
					mysql_query($query);
