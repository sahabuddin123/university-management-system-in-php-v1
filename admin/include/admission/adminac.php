...
<html>
    ...
    <body style="background-image:url(./images/inbg.jpg) ">
      ...
      <center>  <table class="table table-bordered" style="font-family: Verdana">
                ...
                <tr>
                 <td style="width:3%;"><img src="./images/Logo-T.gif" width="100%"> </td>
                 <td style="width:8%;"><center><font style="font-family:Arial Black; font-size:20px;">
                    EDUCAFE UNIVERSITY OF SCIENCE AND TECHNOLOGY,  DHAKA- 1207, MOHAMMADPUR</font></center>
                ...
                <center><font style="font-family:Arial Black; font-size:20px;">
                   CUEE ADMIT CARD (2019-20)</font></center>
                </td>
                    <td colspan="2" width="3%" >
                        <?php
                  
                    $picfile_path ='../../../admission/studentpic/';
                 ...
                 <td style="width:4%;"> <font style="font-family: Verdana;">Date</font> </td>
                    <td style="width:8%;" colspan="3"><font style="font-family: Verdana; font-weight: bold">
                        10th oct 2019, Afternoon Session</font> </td>
                 </tr>
                ...
                <tr>
                 ...
                 <tr>
                    ...
                    <td style="width:8%;" colspan="3">
                       <span style="font-family: Verdana; font-weight: bold"> EDUCAFE UNIVERSITY OF SCIENCE AND TECHNOLOGY<br>
                        At - Mohammadpur<br>
                        P.O - Mohammadpur, Tejgoun<br>
                        Dist: Dhaka - 1200<br>
                        Dhaka, Bangladesh<br>
