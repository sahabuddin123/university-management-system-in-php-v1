...
$subjectcrt=$_POST['subjectcr']; 
$subjectcode=$_POST['subjectcode']; 
	
$sql="INSERT INTO  tblsubjects(SubjectName,SubjectCradite,SubjectCode) VALUES(:subjectname,:subjectcr,:subjectcode)";
$query = $dbh->prepare($sql);
$query->bindParam(':subjectname',$subjectname,PDO::PARAM_STR);
$query->bindParam(':subjectcr',$subjectcrt,PDO::PARAM_STR);
...
<div class="form-group">
 ...
 <input type="text" name="subjectcode" class="form-control" id="default" placeholder="Subject Code" required="required">
													...
													<div class="form-group">
                                                        <label for="default" class="col-sm-2 control-label">Subject Cadite</label>
                                                        <div class="col-sm-10">
 <input type="text" name="subjectcr" class="form-control" id="default" placeholder="Subject Cadite" required="required">
                                                        </div>
                                                    </div>
