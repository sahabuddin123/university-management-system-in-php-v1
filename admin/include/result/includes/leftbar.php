<div class="left-sidebar bg-black-300 box-shadow ">
                        <div class="sidebar-content">
                            <div class="user-info closed">
                                <img src="http://placehold.it/90/c2c2c2?text=User" alt="Sahab Uddine" class="img-circle profile-img">
                                <h6 class="title">Sahab Uddin</h6>
                            ...
                            <div class="sidebar-nav">
                                <ul class="side-nav color-gray">
                                    ...
                                    <li>
                                        <a href="dashboard.php"><i class="fa fa-dashboard"></i> <span>Feni Polytechnic Institute</span> </a>
...
<li class="has-children">
									...
									<li><a href="http://localhost/www.fpi.com/admin/dashboard.php"><i class="fa fa fa-server"></i> <span> Home</span></a></li>
