...
<html>
    ...
    <body>
      ...
      <center>  <table class="table table-bordered" style="font-family: Verdana">
                ...
                <tr>
                 <td style="width:3%;"><br><br><img src="./images/Logo-T.gif" width="100%"> </td>
                ...
                //   echo "Hello";
                    ...
                    while($row1 = mysqli_fetch_array($result1))
                      {                  
                        ...
                        echo "<img src='$picsrc.' class='img-thumbnail' width='180px' style='height:180px;' alt='no image select'>";
                        echo"<div>";
                      }
